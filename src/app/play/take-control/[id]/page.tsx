...
const staticTracks: Record<number, Track> = {
  11: {
    id: 11,
    title: 'Short Version',
    description: 'A focused 5-minute session to build mental control',
    duration: 300,
    type: 'take-control',
  ...
  12: {
    ...
    description: 'A balanced 10-minute session for developing mental strength',
    duration: 600,
    type: 'take-control',
    audio_url: 'https://nbbizrkpeadukjbtnazf.supabase.co/storage/v1/object/sign/testbucket/Intro%201.mp3?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1cmwiOiJ0ZXN0YnVja2V0L0ludHJvIDEubXAzIiwiaWF0IjoxNzQ0NTcyNjIwLCJleHAiOjIwNTk5MzI2MjB9.nlV9hov0XpXSs5Zx1rbGTCX-W5Dtm9GMnm3GZltJei4',
    created_at: new Date().toISOString()
  ...
  13: {
    id: 13,
    title: 'Long Version',
    description: 'A comprehensive 20-minute session for mastering mental control',
    duration: 1200,
    type: 'take-control',
    audio_url: 'https://nbbizrkpeadukjbtnazf.supabase.co/storage/v1/object/sign/testbucket/Intro%201.mp3?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1cmwiOiJ0ZXN0YnVja2V0L0ludHJvIDEubXAzIiwiaWF0IjoxNzQ0NTcyNjIwLCJleHAiOjIwNTk5MzI2MjB9.nlV9hov0XpXSs5Zx1rbGTCX-W5Dtm9GMnm3GZltJei4',
    created_at: new Date().toISOString()
