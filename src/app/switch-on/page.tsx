...
export default function SwitchOn() {
  ...
  const sessions = [
    { title: 'Short Version', duration: '5 Minutes', type: 'switch', id: 'short' },
    { title: 'Medium Version', duration: '10 Minutes', type: 'switch', id: 'medium' },
    { title: 'Long Version', duration: '20 Minutes', type: 'switch', id: 'long' },
  ]
